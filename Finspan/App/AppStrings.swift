...
enum AppStrings {
    enum Lobby {
        ...
        static let mainMenuTitle = "Finspan"
        ...
        static let profileSetupDescription = "昵称和头像只用于本机展示，玩家身份会使用独立的本地 id。"
        static let nickname = "昵称"
        static let avatar = "头像"
        static let saveProfile = "保存资料"
        static let editProfile = "修改资料"
        static let profileNicknameRequired = "请输入昵称。"
        static let profileRequiredBeforeRoom = "请先设置玩家资料。"
        static let roomName = "房间名称"
        static let roomNamePlaceholder = "不填则使用默认名称"
        static let randomRoomName = "随机房间名"
        static let playerCount = "玩家人数"
        static let localPlayerCountNote = "当前仍使用本地模拟玩家流程。"
        static let createRoomFooter = "创建房间"
        static let roomLobbyTitle = "房间等待"
        static let roomConfigSummary = "房间配置"
        static let enabledExpansions = "启用扩展"
        static let noExpansionEnabled = "未启用扩展"
        static let weeklyGoalSideBRandomSummary = "B 面 · 随机周目标"
        static let weeklyGoalSideBCustomSummary = "B 面 · 自选周目标"
        static let randomWeeklyGoalHiddenNote = "开始游戏后随机揭示周目标。"
        static let joinGameTitle = "可加入的房间"
        static let noJoinableRooms = "暂无可加入房间"
        static let noJoinableRoomsDescription = "当前没有发现房间，你可以创建一个新房间。"
        static let refreshRooms = "刷新"
        static let localRoomListNote = "当前仅显示本机房间，真实局域网搜索暂未接入。"
        static let automaTitle = "自动鱼"
        static let automaPlaceholder = "自动鱼单人模式暂未实现。"
        static let back = "返回"
        static let returnToMainMenu = "返回大厅"
        static let dissolveRoom = "解散房间"
        static let dissolveRoomConfirmTitle = "确定要解散房间吗？"
        static let dissolveRoomConfirmMessage = "解散后，本机房间列表中将不再显示这个房间。"
        static let hostedByMeBadge = "我创建的"
        static let startGame = "开始游戏"
        static let readyStatus = "已准备"
        static let notReadyStatus = "未准备"
        static let hostBadge = "房主"
        static let unnamedRoom = "未命名房间"
    ...
    enum GameBoard {
        ...
        static let viewing = "正在查看"
        static let returnToOwnBoard = "返回自己"
        static let readOnlyBoard = "只读查看"
        static let viewSourceBoard = "查看来源面板"
        static let sourceFishHighlight = "来源鱼"
        static let returnToOwnBoardToChooseTarget = "请返回自己面板选择目标"
        static let returnToOwnBoardToChoosePayment = "请返回自己面板选择支付来源"
        static let handRemainsOwnWhileViewingOpponent = "正在查看对手，手牌仍为你自己的手牌"
        ...
        static let chooseLeftTarget = "请选择一个高亮目标"
        static let invalidRewardTarget = "此处不能作为当前能力的目标"
        static let invalidRewardSource = "此处不能作为当前能力的来源"
        ...
        static let abilityEngineV2Blocked = "暂不可用"
        ...
        static let finishAbilityShort = "结束"
        ...
        static let discardPileRecoverSelectionInstruction = "选择 1 张弃牌拿回，或改为抽 1 张鱼牌。"
        static let recoverSelectedDiscardCard = "拿回所选弃牌"
        static let drawInstead = "改为抽牌"
